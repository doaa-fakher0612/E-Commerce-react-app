        ...
        return (
          ...
          >
            <div id="imgContainer" className="w-full rounded h-80 p-4">
                <img id = "productImg" src={`${product.image}`} className="w-full rounded h-full object-contain"></img>
            </div>
            <div id="textContainer" className="flex flex-col gap-2">
                <h1 id="productTitle"
                className="md:text-2xl font-bold text-xl line-clamp-1">{product.title}</h1>
                <p id="description"
                className="text-gray-600 text-sm md:text-base break-words line-clamp-3">{product.description}</p>
            </div>
            <div id="productFooter" className="flex flex-col items-start justify-center w-full gap-4">
                <h4 id="price"
